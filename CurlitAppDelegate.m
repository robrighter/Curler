...
- (void)requestComplete: (NSString*) response {
	...
	[[self.webView mainFrame] loadHTMLString: [NSString stringWithFormat:[NSString stringWithContentsOfFile: filePath], [self replaceGtAndLtInString:response]] baseURL: url];
}
